...
## release note
* 0.2.6, fix most european option test, tree engine cleanup
* 0.2.5, fix piecewise zero spreaded term structure, brownian bridge, 4 american options specs, FD engine cleanup
